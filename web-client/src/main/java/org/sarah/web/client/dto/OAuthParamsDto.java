...
public class OAuthParamsDto {
	...
	public OAuthParamsDto(String consumerSecret, String consumerKey, String nonce, String signatureMethod,
			String signature, String timestamp, String method, String oAuthVersion, String oAuthToken,
			String oAuthTokenSecret) {
		super();
	...
	public OAuthParamsDto(String consumerSecret, String consumerKey, String nonce, String signatureMethod,
			String signature, String timestamp, String method, String oAuthVersion, String oAuthToken,
			String oAuthTokenSecret, HashMap<String, String> formData, String url) {
		super();
		this.consumerSecret = consumerSecret;
		this.consumerKey = consumerKey;
		this.nonce = nonce;
